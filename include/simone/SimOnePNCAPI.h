...
extern "C"
{
	...
	namespace SimOneAPI {
		...
		*		ESimOne_Drive_Mode_API: driving by API controlling module
		*		ESimOne_Drive_Mode_Driver: driving by SimOneDriver controlling module
		*		ESimOne_Drive_Mode_API_Lateral: lateral control under API module, longitudinal control under SimOneDriver module
		*		ESimOne_Drive_Mode_API_Longitudinal: lateral control under SimOneDriver module,longitudinal control under API module
		@param[in]
		*	mainVehicleId: Id of the main vehicle
		@param[in]
		*	driveMode: vehicle driving control mode
		@return
		*	Success or not
		*/
		...
		*	SetVehicleInitState
		\li brief:
		*	Reset the mainvehicle state to the initial state
		@param[in]
		*	mainVehicleId: Id of the main vehicle
		@return
		*	Success or not
