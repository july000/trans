...
extern "C"
{
	...
	namespace SimOneAPI{
		...
		*	InitEvaluationService
		\li brief:
		*	Initialize service for evaluation to autonomous-driving algorithm
		*	Judge data and GPS data that being sent to evaluation service as default(category: judge, mainvehicle)
		@param[in]
		*	mainVehicleId: Id of the main vehicle
		@param[in]
		*	serviceIP: Evaluation service ip
		@param[in]
		*	port: Evaluation service port
		@param[in]
		*	withMainVehicle: whether to send MainVehicle data to evaluation server
		@param[in]
		*	withObstacleNeeded: whether to send Obstacle data to evaluation server
		@return
		*	Success or not
		*/
		...
		*	SetJudgeEventCB
		\li brief:
		*	Register the callback func applying for judge event of the scenario 
		@param[in]
		*	cb: scenario judge event callback function
		@param[out]
		*	mainVehicleId: Id of the main vehicle
		@param[out]
		*	judgeEventDetailInfo: judge event info of the scenario
		@return
		*	Success or not
		*/
		...
		*	AddJudgeEvent
		\li brief:
		*	Broadcast scenario judgment event info for report generation
		@param[in]
		*	mainVehicleId: Id of the main vehicle
		@param[in]
		*	data: Judge event info of the scenario
		@param[in]
		*   terminate: Whether to terminate the scenario. default: false
		@return
		*	Success or not
		*/
